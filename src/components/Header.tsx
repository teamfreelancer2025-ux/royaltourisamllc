          ...
          <div className="lg:hidden py-4 border-t border-border">
            <nav className="flex flex-col space-y-4">
              ...
              <div className="flex items-center justify-center gap-4 py-4 border-t border-border mt-4">
                ...
                <a href="https://www.instagram.com/royalcitytourisms/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-muted-foreground hover:text-primary transition-colors">
                ...
                <a href="https://x.com/RoyalcityT76392" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="text-muted-foreground hover:text-primary transition-colors">
                ...
                <a href="https://www.linkedin.com/in/royalcitytourism-llc-8b8787387/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-muted-foreground hover:text-primary transition-colors">
                ...
                <a href="https://medium.com/" target="_blank" rel="noopener noreferrer" aria-label="Medium" className="text-muted-foreground hover:text-primary transition-colors">
